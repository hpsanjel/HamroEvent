  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      ...
      const defaultSettings = {
        ...settings,
        darkMode: prefersDark // Set based on system preference
      };
    ...
    <div className="fixed bottom-6 right-6 z-[9999] accessibility-widget">
        ...
        {!isOpen && (
          <Button
            ...
            size="lg"
            className="rounded-full w-14 h-14 shadow-lg bg-red-500 hover:bg-red-600 text-white border-2 border-white animate-pulse"
          ...
          <CardHeader className="pb-3">
            <div className="flex flex-col gap-3">
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                <p className="text-base">Accessibility Settings</p>
              </CardTitle>
